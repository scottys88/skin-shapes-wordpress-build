...
function woocommerce_template_loop_product_link_open() {
	echo '<div class="product-container"><a href="' . esc_url( get_the_permalink() ) . '" class="image-link">';
}
/**
 * Insert the opening anchor tag for products in the loop.
 */
		...
		if ( $product ) {
			$defaults = array(
				...
				'class'    => implode( ' ', array_filter( array(
						'btn btn-add-to-cart btn-primary primary-btn-override',
...
if ( ! function_exists( 'woocommerce_get_product_thumbnail' ) ) {
	 ...
	 * @return string
	 */
	function woocommerce_get_product_thumbnail( $size = ' product-image shop_catalog', $deprecated1 = 0, $deprecated2 = 0 ) {
		global $product;
